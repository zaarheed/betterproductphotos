            ...
            <div className="w-full max-w-6xl mx-auto px-4 flex flex-col md:flex-row">
                <div className="w-full md:w-7/12 flex flex-col">
                    <p className="text-4xl font-black font-poppins mb-10 leading-[3.5rem]">
                        The best brands and franchises use high-quality, professionally shot photos. Camera
                        roll snaps limit the online success for your business.
                    </p>
                </div>
                <div className="relative w-full md:w-5/12 flex flex-col">
                    ...
                    <InstagramPost
                        imgUrl="/assets/examples/1/cover.jpg"
                        comments={0}
                        likes="6"
                    />
                </div>

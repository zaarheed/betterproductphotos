            ...
            <div className="w-full max-w-6xl mx-auto px-4 flex flex-col md:flex-row md:space-x-4">
                <div className="w-full md:w-7/12 flex flex-col">
                    <p className="text-4xl font-black font-poppins mb-10 leading-[3.5rem]">
                        Use your photos to get <img src="/assets/instagram-likes.svg" className="inline-block h-12 mx-2" />
                ...
                <div className="relative w-full md:w-5/12 flex flex-col py-20 md:py-10">
                    ...
                    <div className="relative w-full h-full">
                        <div className="absolute top-0 left-0 -rotate-3">
                            <InstagramPost
                                imgUrl="/assets/examples/3/result-4.jpg"
                                comments={90}
                                likes="1.2K"
                            />
                        </div>
                        <div className="absolute top-0 left-0">
                            <InstagramPost
                                imgUrl="/assets/examples/4/result-3.jpg"
                                comments={90}
                                likes="1.2K"
                            />
                        </div>
                        <div className="absolute top-0 left-0 rotate-3">
                            <InstagramPost
                                imgUrl="/assets/examples/2/result-2.jpg"
                                comments={90}
                                likes="1.2K"
                            />
                        </div>

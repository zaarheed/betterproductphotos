	...
	return (
		<div className="w-full mt-32">
            ...
            <div className="w-full flex flex-row justify-center mt-8 px-4 space-x-4">
                ...
                <button
                    className={`
                        border-4 p-2 w-full md:w-auto border-black dark:border-zinc-100 bg-black dark:bg-zinc-100 focus:outline-none group
                        hover:bg-white dark:hover:bg-zinc-100 group cursor-pointer
                    `}
                    type="button"
                    onClick={() => router.push("/free")}
                >
                    <a
                        className={`
                            font-extrabold text-center w-full text-lg md:text-4xl py-2 px-3 bg-black dark:bg-zinc-100 text-white
                            dark:text-zinc-900 group-hover:bg-white dark:group-hover:bg-zinc-100 group-hover:text-black
                            dark:group-hover:text-zinc-900 group-hover:scale-105 duration-200
                        `}
                        target="_blank"
                        href={SUBSCRIPTION_LINK}
                    >
                        Go pro{" "}
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="-mt-2 w-8 h-8 md:w-10 md:h-10 text-yellow-500 inline-block">

...
export default function StepFour() {
    ...
    return (
        <div className="w-full flex flex-col">
            ...
            <div className="my-4 w-full bg-black dark:bg-yellow-600 rounded-lg p-4 text-white dark:text-zinc-100 flex flex-row items-center space-x-1">
                ...
                <p className="text-lg font-poppins font-medium">
                    This is a demo and all images are pre-generated irrespective of your input.
                </p>
            </div>
